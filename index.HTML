...
<body>
    ...
    */
    ...
    var negateHeaderOffSet = $("nav ul#main-list").css("margin-top");
        ...
        if (positionFromTopForWindow == 0) {
            ...
            $("nav").css("opacity", "0");
            $("nav").animate({"top": "0px"}, 20, function() {
                $(this).fadeTo(500, 1);
    ...
    $(".search-bar").click(function() {
         ...
         */
            ...
            $(".carousel").css({"margin-left": totalMarginOfVideo, "margin-right": totalMarginOfVideo})
           $(".hover-menu").css({"margin-left": totalMarginOfVideo, "margin-right": totalMarginOfVideo});
            ...
            $(".header-widgets").css({"margin-left": totalMarginOfVideo, "margin-right": totalMarginOfVideo});
            var margin3Percent = ($(window).width()/100)*3;
            var loginButtonMarin = totalMarginOfVideo + margin3Percent + 30; //30 for the body marginsa
            
            $(".login-button1").css("margin-right", loginButtonMarin);
    ...
    <span class = "login-button"> LOG IN </span>    
        ...
        <div class = "align-donate-subscribe">
    ...
    <nav>
      <ul id = "main-list">
       ...
       <li> <span class = "fa fa-search search-bar"></span></li> 
    ...
    <div class = "search-menu">
        ...
        <br>
        <button style="border: 0; background: transparent" type = "submit"><span style = "margin-top: 5px;" class = "fa fa-search"></button></span>
        </form>
  ...
  <div class="carousel-inner" role="listbox">
    <div class="carousel-item active">
      <img class="d-block img-fluid" src="https://staticdelivery.nexusmods.com/mods/110/images/hot/81312.jpg" alt="First slide">
        
      <div class="carousel-caption">
        <h3 id = "type-of-content">Review</h3>
      </div>
      <div class="carousel-caption">
     ...
     <div class="carousel-caption">
        <p id = "review-preview">111Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam et dapibus velit. Nulla imperdiet, nibh in feugiat consectetur, nibh tortor sodales metus, eget condimentum sapien dolor ac sem. Cras vehicula pellentesque nisl, nec varius felis. Sed pharetra suscipit lacus sed euismod. Vestibulum imperdiet, augue nec ullamcorper commodo, ante enim vulputate purus, at vulputate orci sem eget magna. Praesent in quam at diam maximus mattis. Sed pulvinar augue feugiat urna suscipit.<br><a id = "read-more" href = "#">Read More</a> </p>
      </div>   
    ...
    <div class="carousel-item">
      <img class="d-block img-fluid" src="https://staticdelivery.nexusmods.com/mods/110/images/hot/81312.jpg" alt="Second slide">
     ...
     <div class="carousel-caption">
        <p id = "review-preview">222Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam et dapibus velit. Nulla imperdiet, nibh in feugiat consectetur, nibh tortor sodales metus, eget condimentum sapien dolor ac sem. Cras vehicula pellentesque nisl, nec varius felis. Sed pharetra suscipit lacus sed euismod. Vestibulum imperdiet, augue nec ullamcorper commodo, ante enim vulputate purus, at vulputate orci sem eget magna. Praesent in quam at diam maximus mattis. Sed pulvinar augue feugiat urna suscipit. <br><a id = "read-more" href = "#">Read More</a></p>
      </div> 
    ...
    <div class="carousel-item">
      <img class="d-block img-fluid" src="https://staticdelivery.nexusmods.com/mods/110/images/hot/81312.jpg" alt="Third slide">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="carousel-item active">
      <iframe src="https://www.youtube.com/embed/fiGsmtjYNss" allowfullscreen="" frameborder="0"></iframe>
     ...
     <div class="carousel-caption">
        <p id = "video-preview">11111Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam et dapibus velit. Nulla imperdiet, nibh in feugiat consectetur, nibh tortor sodales metus, eget condimentum sapien dolor ac sem. Cras vehicula pellentesque nisl, nec varius felis. Sed pharetra suscipit lacus sed euismod. Vestibulum imperdiet, augue nec ullamcorper commodo, ante enim vulputate purus, at vulputate orci sem eget magna. Praesent in quam at diam maximus mattis. Sed pulvinar augue feugiat urna suscipit.</p>
      </div>   
    ...
    <div class="carousel-item">
     ...
     <div class="carousel-caption">
        <p id = "video-preview">2222Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam et dapibus velit. Nulla imperdiet, nibh in feugiat consectetur, nibh tortor sodales metus, eget condimentum sapien dolor ac sem. Cras vehicula pellentesque nisl, nec varius felis. Sed pharetra suscipit lacus sed euismod. Vestibulum imperdiet, augue nec ullamcorper commodo, ante enim vulputate purus, at vulputate orci sem eget magna. Praesent in quam at diam maximus mattis. Sed pulvinar augue feugiat urna suscipit.</p>
      </div> 
    ...
    <div class="carousel-item">
     ...
     <div class="carousel-caption">
        <p id = "video-preview">3333Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam et dapibus velit. Nulla imperdiet, nibh in feugiat consectetur, nibh tortor sodales metus, eget condimentum sapien dolor ac sem. Cras vehicula pellentesque nisl, nec varius felis. Sed pharetra suscipit lacus sed euismod. Vestibulum imperdiet, augue nec ullamcorper commodo, ante enim vulputate purus, at vulputate orci sem eget magna. Praesent in quam at diam maximus mattis. Sed pulvinar augue feugiat urna suscipit.</p>
      </div> 
